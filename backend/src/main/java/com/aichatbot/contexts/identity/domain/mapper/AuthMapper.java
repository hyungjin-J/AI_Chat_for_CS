...
public interface AuthMapper {
    ...
    AuthSessionRecord findSessionByTokenHash(@Param("tenantId") UUID tenantId,
                                             @Param("tokenHash") String tokenHash);

    int consumeRefreshSessionByTokenHash(@Param("tenantId") UUID tenantId,
                                         @Param("tokenHash") String tokenHash,
    ...
    int revokeSessionByTokenHash(@Param("tenantId") UUID tenantId,
                                 @Param("tokenHash") String tokenHash,
                                 @Param("revokedAt") Instant revokedAt,
                                 @Param("reason") String reason);
