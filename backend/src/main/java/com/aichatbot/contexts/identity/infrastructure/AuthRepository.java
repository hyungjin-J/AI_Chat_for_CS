package com.aichatbot.contexts.identity.infrastructure;
...
import com.aichatbot.contexts.identity.domain.AuthUserProjection;
import com.aichatbot.contexts.identity.domain.mapper.AuthMapper;
...
public class AuthRepository {
    ...
    public Optional<AuthSessionRecord> findSessionByTokenHash(UUID tenantId, String tokenHash) {
        return Optional.ofNullable(authMapper.findSessionByTokenHash(tenantId, tokenHash));
    }

    public int consumeRefreshSessionByTokenHash(UUID tenantId, String tokenHash, Instant consumedAt, String consumedIp) {
        return authMapper.consumeRefreshSessionByTokenHash(tenantId, tokenHash, consumedAt, consumedIp);
    }
    ...
    public int revokeSessionByTokenHash(UUID tenantId, String tokenHash, Instant revokedAt, String reason) {
        return authMapper.revokeSessionByTokenHash(tenantId, tokenHash, revokedAt, reason);
    }
